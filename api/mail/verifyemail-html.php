...
$resetLink = Yii::$app->params['site_url'].'backend/login/verifyemail?token='.$email_id;
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <p style="font-family: sans-serif;font-size: 14px;font-weight: normal;margin: 0;margin-bottom: 15px;">Congratulations! You have registered successfully!.</p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <?= Html::a('Click here to verify email', $resetLink,['style' => 'background-color: #ffffff;border: solid 1px #3498db;border-radius: 5px;box-sizing: border-box;color: #3498db;cursor: pointer;display: inline-block;font-size: 14px;font-weight: bold;margin: 0;padding: 12px 25px;text-decoration: none;text-transform: capitalize;']); ?> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <br>
                        <small  style="font-family: sans-serif;font-weight: normal;margin-top: 15px;margin-bottom: 15px;"><i>[Note: If you already verified email address, ignore this email.]</i></small>
                      </td>
                    </tr>
                  </table>
                </td>
