...
<div class="poly-user-form">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <?= $form->field($model, 'promotion_points')->textInput(['autofocus'=>'true','placeholder'=>'Price' ]) ?> 
        </div>
    </div>
    <div class="row">
        <div class="col-lg-6">
            <?= $form->field($model, 'merchant_code')->textInput(['autofocus'=>'true','placeholder'=>'Merchant Promotion code' ]) ?> 
        </div>
    </div>
